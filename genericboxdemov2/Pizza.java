 ...
 */
public class Pizza {   // NOTE: the Pizza is NOT Comparable
    ...
    public String toString() {
        ...
        if (size == 1) {
            stringToReturn = "Small Pizza";
        } else if (size == 2) {
            stringToReturn = "Medium Pizza";
        } else if (size == 3) {
            stringToReturn = "Large Pizza";
        } else {
        ...
        stringToReturn = stringToReturn + "\tCost " + DisplayNeat.number(cost());
    ...
    public boolean equals(Object otherObject) throws ClassCastException {
        ...
        if (!(otherObject instanceof Pizza)) {
            throw new ClassCastException("Dude...I wanted a pizza!.");
        }

        // if we got here, otherObject is a Pizza - cast as Pizza!
